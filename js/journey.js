...
{ month: "June", content: "Elected as Chair of Human Toxicology Student Advisory Committee (ToxSAC) and Treasurer for Connecting Science to Society. " },
{ month: "August", content: "Selected as AAAS Superhero for STEAM Enthusiasts Community" },
        { month: "September", content: "Elected as Graduate Student Senator (GSS) representing Human Toxicology. Selected to serve as co-chair of Jakobsen Conference Planning Committee." },
    { month: "October", content: "Selected for 'Dare to Discover' downtown campaign." },
    { month: "November", content: "Received HAWK-AI level 3 certification from the Iowa Institute of Artificial Intelligence." }
],
